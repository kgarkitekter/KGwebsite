...
const BookingSection = () => {
  ...
  const handleBookingSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const formattedTime = format(selectedTime.date, 'h:mm a');
      ...
      // Send booking data to our API route
      ...
      console.log('Booking confirmed and emails sent to:', {
        client: formData.email,
        architect: 'karin.gunnerek@gmail.com'
      });
